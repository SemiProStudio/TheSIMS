...
// Lazy-loaded modals
const ItemModal = lazy(() => import('./modals/ItemModal').then(m => ({ default: m.ItemModal })));
const ReservationModal = lazy(() => import('./modals/ReservationModal').then(m => ({ default: m.ReservationModal })));
const QRModal = lazy(() => import('./modals/QRModal').then(m => ({ default: m.QRModal })));
...
const ImageSelectorModal = lazy(() => import('./modals/ImageSelectorModal').then(m => ({ default: m.ImageSelectorModal })));
const QRScannerModal = lazy(() => import('./modals/QRScannerModal').then(m => ({ default: m.QRScannerModal })));
const CSVImportModal = lazy(() => import('./modals/CSVImportModal').then(m => ({ default: m.CSVImportModal })));
const DatabaseExportModal = lazy(() => import('./modals/DatabaseExportModal').then(m => ({ default: m.DatabaseExportModal })));
const CheckOutModal = lazy(() => import('./modals/CheckOutModal').then(m => ({ default: m.CheckOutModal })));
const CheckInModal = lazy(() => import('./modals/CheckInModal').then(m => ({ default: m.CheckInModal })));
const MaintenanceModal = lazy(() => import('./modals/MaintenanceModal').then(m => ({ default: m.MaintenanceModal })));
const BulkStatusModal = lazy(() => import('./modals/BulkModals').then(m => ({ default: m.BulkStatusModal })));
const BulkLocationModal = lazy(() => import('./modals/BulkModals').then(m => ({ default: m.BulkLocationModal })));
const BulkCategoryModal = lazy(() => import('./modals/BulkModals').then(m => ({ default: m.BulkCategoryModal })));
const BulkDeleteModal = lazy(() => import('./modals/BulkModals').then(m => ({ default: m.BulkDeleteModal })));
const AddUserModal = lazy(() => import('./modals/AddUserModal').then(m => ({ default: m.AddUserModal })));
