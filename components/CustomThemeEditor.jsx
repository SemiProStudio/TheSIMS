        ...
        <div style={{ padding: `0 ${spacing[3]}px ${spacing[3]}px` }}>
          {category.colors.map((colorDef) => (
            ...
            >
              ...
              />
              <span
                style={{ flex: 1, fontSize: typography.fontSize.sm, color: colors.textPrimary }}
              >
                {colorDef.label}
              </span>
              <span
    ...
    <Card>
      ...
      >
        ...
        >
          ...
          <div
            style={{
              background: themeColors['--bg-light'],
              borderRadius: borderRadius.sm,
              padding: spacing[2],
            }}
          >
            ...
            <div style={{ color: themeColors['--text-muted'], fontSize: typography.fontSize.xs }}>
              Sample text
            </div>
          </div>
        </div>
        ...
        {/* Status badges */}
        <div
          style={{ display: 'flex', gap: spacing[1], flexWrap: 'wrap', marginBottom: spacing[2] }}
        >
          {[
            '--status-available',
            '--status-checked-out',
      ...
      {expanded && (
        <div style={{ marginTop: spacing[3] }}>
          ...
          {summary.score < 80 && (
            ...
            >
              <strong>Tip:</strong> Increase contrast by using lighter text colors or darker
              backgrounds. WCAG AA requires a minimum contrast ratio of 4.5:1 for normal text.
            </div>
          )}
        </div>
      )}
...
function CustomThemeEditor({ onBack, onSave, existingTheme }) {
    ...
    onSave?.({
      ...
      colors: {
        ...
        '--focus-ring-color-danger':
          themeColors['--focus-ring-color-danger'] || themeColors['--danger'],
      },
      isCustom: true,
    });
    setHasChanges(false);
  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto', padding: spacing[4] }}>
      ...
      {/* Header */}
      <div
        style={{ display: 'flex', alignItems: 'center', gap: spacing[3], marginBottom: spacing[4] }}
      >
        <div
          style={{
            width: 48,
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: spacing[4] }}>
        ...
        <div>
          ...
          >
            ...
            <Button onClick={handleSave} icon={Save} disabled={!hasChanges}>
              Save Theme
            </Button>
          </div>
        </div>
