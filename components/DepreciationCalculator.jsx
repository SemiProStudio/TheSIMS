...
function DepreciationCalculator({ item, onUpdateValue }) {
  ...
  const [usefulLife, setUsefulLife] = useState(DEFAULT_USEFUL_LIFE[item.category] || 5);
        ...
        {showInfo && (
          ...
          >
            ...
            <ul style={{ margin: `${spacing[2]}px 0 0 0`, paddingLeft: spacing[4] }}>
              ...
              <li>
                <strong>Declining Balance:</strong> 150% of straight-line rate applied to remaining
                value
              </li>
              <li>
                <strong>Double Declining:</strong> 200% of straight-line rate (accelerated)
              </li>
            </ul>
          </div>
        )}
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSalvagePercent(Math.max(0, Math.min(100, parseInt(e.target.value) || 0)))
              }
              min="0"
              max="100"
              style={{ ...styles.input, fontSize: typography.fontSize.sm, padding: spacing[2] }}
          ...
          <>
            ...
            >
              ...
              <div
                style={{
                  padding: spacing[2],
                  background: `${withOpacity(colors.accent1, 10)}`,
                  borderRadius: borderRadius.md,
                  textAlign: 'center',
                }}
              >
