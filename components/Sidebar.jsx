  ...
  return (
    ...
    >
      <Icon
        size={18}
        aria-hidden="true"
        style={{ color: isActive ? activeColor : 'inherit', flexShrink: 0 }}
      />
      <span
...
const VIEW_LABELS = {
  ...
  [VIEWS.CLIENT_REPORT]: 'Client Report',
  [VIEWS.PACKAGE_DETAIL]: 'Package Details',
  [VIEWS.SEARCH]: 'Search',
  [VIEWS.ADMIN]: 'Admin Panel',
  [VIEWS.REPORTS]: 'Reports',
  [VIEWS.INVENTORY_REPORT]: 'Inventory Report',
  [VIEWS.ACTIVITY_REPORT]: 'Activity Report',
  [VIEWS.ALERTS_REPORT]: 'Alerts Report',
  [VIEWS.CHANGE_LOG]: 'Change Log',
  [VIEWS.EMAIL_LOG]: 'Email Log',
  [VIEWS.ROLES_MANAGE]: 'Role Management',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* The app-wide h1 — the ONLY one per page (accessibility.spec
                  pins the count). Every view, detail pages included, renders
                  its title as h2 under it. */}
              <h1
                style={{
                  margin: 0,
        ...
        <div ref={userMenuRef} style={{ position: 'relative', width: collapsed ? 'auto' : '100%' }}>
          ...
          {showUserMenu && (
            ...
            >
              ...
              <button
                onClick={() => {
                  setCurrentView(VIEWS.NOTIFICATIONS);
                  setShowUserMenu(false);
                }}
                className="user-menu-item"
                style={{
