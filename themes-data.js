...
export const COLOR_KEYS = [
  ...
  '--panel-stats', '--panel-search', '--panel-checkedout', '--panel-alerts', '--panel-reminders', '--panel-lowstock', '--panel-reservations', '--panel-maintenance', '--panel-activity',
...
export const themes = {
  light: {
    ...
    colors: {
      ...
      '--panel-stats': '#2563eb', '--panel-search': '#0891b2', '--panel-checkedout': '#0d9488', '--panel-alerts': '#ea580c', '--panel-reminders': '#a16207', '--panel-lowstock': '#dc2626', '--panel-reservations': '#7c3aed', '--panel-maintenance': '#6366f1', '--panel-activity': '#059669',
      ...shadow(0.08),
    }
  },
  ...
  darker: {
    ...
    colors: {
      ...
      '--panel-stats': '#555555', '--panel-search': '#555555', '--panel-checkedout': '#555555', '--panel-alerts': '#555555', '--panel-reminders': '#555555', '--panel-lowstock': '#555555', '--panel-reservations': '#555555', '--panel-maintenance': '#555555', '--panel-activity': '#555555',
      ...shadow(0.5),
    }
  },
  ...
  primaries: {
    ...
    colors: {
      ...
      '--panel-stats': '#1565c0', '--panel-search': '#2e7d32', '--panel-checkedout': '#00838f', '--panel-alerts': '#e65100', '--panel-reminders': '#7b1fa2', '--panel-lowstock': '#c62828', '--panel-reservations': '#d32f2f', '--panel-maintenance': '#795548', '--panel-activity': '#558b2f',
  ...
  pastel: {
    ...
    colors: {
      ...
      '--panel-stats': '#7c3aed', '--panel-search': '#0891b2', '--panel-checkedout': '#059669', '--panel-alerts': '#ea580c', '--panel-reminders': '#8a6914', '--panel-lowstock': '#e11d48', '--panel-reservations': '#4f46e5', '--panel-maintenance': '#6366f1', '--panel-activity': '#0d9488',
      ...shadow(0.1),
    }
  },
  ...
  terminal: {
    ...
    colors: {
      ...
      '--panel-stats': '#00ff00', '--panel-search': '#00ff66', '--panel-checkedout': '#00dd00', '--panel-alerts': '#ffff00', '--panel-reminders': '#00ffaa', '--panel-lowstock': '#ff0000', '--panel-reservations': '#66ff00', '--panel-maintenance': '#00cc00', '--panel-activity': '#33ff33',
  ...
  blackwhite: {
    ...
    colors: {
      ...
      '--panel-stats': '#333333', '--panel-search': '#555555', '--panel-checkedout': '#444444', '--panel-alerts': '#777777', '--panel-reminders': '#444444', '--panel-lowstock': '#222222', '--panel-reservations': '#666666', '--panel-maintenance': '#555555', '--panel-activity': '#333333',
      ...shadow(0.1),
    }
  },
  ...
  vibrant: {
    ...
    colors: {
      ...
      '--panel-stats': '#00f5d4', '--panel-search': '#00bbf9', '--panel-checkedout': '#a46aeb', '--panel-alerts': '#fee440', '--panel-reminders': '#00ff87', '--panel-lowstock': '#f15bb5', '--panel-reservations': '#ff006e', '--panel-maintenance': '#00bbf9', '--panel-activity': '#fee440',
  ...
  muted: {
    ...
    colors: {
      ...
      '--panel-stats': '#7ec8b8', '--panel-search': '#7eb8c8', '--panel-checkedout': '#96c9a8', '--panel-alerts': '#c9b896', '--panel-reminders': '#9b8ec8', '--panel-lowstock': '#b87e8b', '--panel-reservations': '#ad919a', '--panel-maintenance': '#c9a896', '--panel-activity': '#8b7eb8',
      ...shadow(0.25),
    }
  },
  ...
  xp: {
    ...
    colors: {
      ...
      '--panel-stats': '#003d99', '--panel-search': '#1b7a1b', '--panel-checkedout': '#007399', '--panel-alerts': '#9e5000', '--panel-reminders': '#990073', '--panel-lowstock': '#a50000', '--panel-reservations': '#7326bf', '--panel-maintenance': '#9e5000', '--panel-activity': '#1b7a1b',
  ...
  cheese: {
    ...
    colors: {
      ...
      '--panel-stats': '#bf360c', '--panel-search': '#8d6e63', '--panel-checkedout': '#a1887f', '--panel-alerts': '#b33a00', '--panel-reminders': '#795548', '--panel-lowstock': '#8c0000', '--panel-reservations': '#6d4c41', '--panel-maintenance': '#5d4037', '--panel-activity': '#8d5600',
      ...shadow(0.25),
    },
  ...
  cats: {
    ...
    colors: {
      ...
      '--panel-stats': '#c2185b', '--panel-search': '#7b1fa2', '--panel-checkedout': '#1565c0', '--panel-alerts': '#d84315', '--panel-reminders': '#512da8', '--panel-lowstock': '#c62828', '--panel-reservations': '#2e7d32', '--panel-maintenance': '#f9a825', '--panel-activity': '#e91e63',
      ...shadow(0.15),
    },
  ...
  dogs: {
    ...
    colors: {
      ...
      '--panel-stats': '#6d4c41', '--panel-search': '#0277bd', '--panel-checkedout': '#ad4e00', '--panel-alerts': '#d84315', '--panel-reminders': '#7b1fa2', '--panel-lowstock': '#c62828', '--panel-reservations': '#558b2f', '--panel-maintenance': '#00838f', '--panel-activity': '#8d6e63',
      ...shadow(0.15),
    },
...
export const generateRandomTheme = () => {
  ...
  return {
    ...
    '--panel-stats': randomColor(), '--panel-search': randomColor(), '--panel-checkedout': randomColor(), '--panel-alerts': randomColor(), '--panel-reminders': randomColor(), '--panel-lowstock': randomColor(), '--panel-reservations': randomColor(), '--panel-maintenance': randomColor(), '--panel-activity': randomColor(),
