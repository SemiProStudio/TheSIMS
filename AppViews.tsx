...
import { rolesService, locationsService, usersService } from './lib/services';
import { useNavigationContext } from './contexts/NavigationContext';
import { useFilterContext } from './contexts/FilterContext';
import { useModalContext } from './contexts/ModalContext';
import { useData } from './contexts/DataContext';
import { PermissionGate } from './contexts/PermissionsContext';
import { ViewLoading } from './components/Loading';
import { generateId } from './utils';

// Core (eagerly loaded)
import Dashboard from './views/Dashboard';
import GearList from './views/GearList';
...
const PackListsView = lazy(() => import('./views/PackListsView'));
const ReservationDetail = lazy(() => import('./views/ReservationDetail'));
const ScheduleView = lazy(() => import('./views/ScheduleView'));
const NotificationSettings = lazy(() => import('./views/NotificationSettings'));
const LocationsManager = lazy(() => import('./views/LocationsManager'));
const LayoutCustomize = lazy(() => import('./views/LayoutCustomize'));
const ThemeSelector = lazy(() => import('./views/ThemeSelector'));
...
const AdminPanel = lazy(() => import('./views/AdminView').then(m => ({ default: m.AdminPanel })));
const UsersPanel = lazy(() => import('./views/UsersView').then(m => ({ default: m.UsersPanel })));
const ReportsPanel = lazy(() => import('./views/ReportsView').then(m => ({ default: m.ReportsPanel })));
const AuditLogPanel = lazy(() => import('./views/AuditLogView').then(m => ({ default: m.AuditLogPanel })));
const MaintenanceReportPanel = lazy(() => import('./views/MaintenanceReportView').then(m => ({ default: m.MaintenanceReportPanel })));
const InsuranceReportPanel = lazy(() => import('./views/InsuranceReportView').then(m => ({ default: m.InsuranceReportPanel })));

const ItemFormPage = lazy(() => import('./views/AdminPages').then(m => ({ default: m.ItemFormPage })));
const SpecsPage = lazy(() => import('./views/AdminPages').then(m => ({ default: m.SpecsPage })));
const CategoriesPage = lazy(() => import('./views/AdminPages').then(m => ({ default: m.CategoriesPage })));
