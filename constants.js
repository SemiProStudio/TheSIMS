...
export const MODALS = {
  ...
  CHECK_OUT: 'check-out',
  CHECK_IN: 'check-in',
  BATCH_CHECK_OUT: 'batch-check-out',
...
export const DASHBOARD_SECTIONS = {
  ...
  TODAY: {
    id: 'today',
    label: 'Today',
    description: 'Overdue, due back today, and going out today',
    order: 2,
  },
  CHECKED_OUT: {
    id: 'checkedOut',
  ...
  ALERTS: { id: 'alerts', label: 'Alerts', description: 'Items needing attention', order: 4 },
  REMINDERS: {
    id: 'reminders',
    label: 'Due Reminders',
