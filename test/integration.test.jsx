...
describe('Check-Out Flow', () => {
      ...
      <div role="dialog" aria-modal="true" aria-label="Check Out Item">
        ...
        <div>
          <input
            ...
            onChange={(e) =>
              setFormData((prev) => ({ ...prev, acknowledgeCondition: e.target.checked }))
            }
          />
  ...
  it('should display item information', () => {
    render(<CheckOutTestWrapper item={mockItem} onCheckOut={vi.fn()} onClose={vi.fn()} />);
  ...
  it('should validate required fields', async () => {
    ...
    render(<CheckOutTestWrapper item={mockItem} onCheckOut={onCheckOut} onClose={vi.fn()} />);
  ...
  it('should submit form with valid data', async () => {
    ...
    render(<CheckOutTestWrapper item={mockItem} onCheckOut={onCheckOut} onClose={onClose} />);
  ...
  it('should close modal on cancel', async () => {
    ...
    render(<CheckOutTestWrapper item={mockItem} onCheckOut={vi.fn()} onClose={onClose} />);
...
describe('Check-In Flow', () => {
  ...
  it('should display checkout information', () => {
    render(<CheckInTestWrapper item={mockCheckedOutItem} onCheckIn={vi.fn()} onClose={vi.fn()} />);
  ...
  it('should submit check-in without damage', async () => {
    ...
    render(
      <CheckInTestWrapper item={mockCheckedOutItem} onCheckIn={onCheckIn} onClose={vi.fn()} />,
    );
...
describe('Item Management Flow', () => {
  ...
  it('should create new item with valid data', async () => {
    ...
    render(<ItemFormTestWrapper item={null} onSave={onSave} onClose={vi.fn()} />);
  ...
  it('should edit existing item', async () => {
    ...
    render(<ItemFormTestWrapper item={mockItem} onSave={onSave} onClose={vi.fn()} />);
...
describe('Search and Filter Flow', () => {
  const SearchableListTestWrapper = ({ items, initialSearch = '' }) => {
    ...
    return (
      <div>
        ...
        {filteredItems.length === 0 && <div role="status">No items match your search criteria</div>}
      </div>
    );
  };
  ...
  it('should filter items by category', async () => {
    const user = userEvent.setup();
    const items = [mockItem, { ...mockItem, id: 'item-3', name: 'Sigma 50mm', category: 'Lens' }];
  ...
  const ReservationFormTestWrapper = ({ reservation, items, clients, onSave, onClose }) => {
    ...
    return (
      ...
      >
        ...
        <div aria-live="polite">{formData.selectedItems.length} items selected</div>
...
describe('Navigation Flow', () => {
  ...
  it('should navigate between views', async () => {
    ...
    expect(screen.getByRole('button', { name: 'Gear List' })).toHaveAttribute(
      'aria-current',
      'page',
    );
      ...
      <div>
        ...
        {selectedIds.length > 0 && (
          <div>
            ...
            <button onClick={() => setShowBulkMenu(!showBulkMenu)} aria-expanded={showBulkMenu}>
              Bulk Actions
            </button>
