...
export function withSentryErrorBoundary(Component, options = {}) {
  if (Sentry) {
    return Sentry.withErrorBoundary(Component, {
      fallback: options.fallback || createElement(DefaultErrorFallback),
...
function DefaultErrorFallback() {
  return createElement('div', {
    ...
    createElement('h2', { style: { color: '#ef4444', marginBottom: '16px' } }, 'Something went wrong'),
    createElement('p', { style: { marginBottom: '20px' } }, "We've been notified and are working on a fix."),
