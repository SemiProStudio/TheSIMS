...
export const inventoryService = {
  ...
  async create(item) {
    ...
    const { validateItem } = await import('./validators');
...
export const reservationsService = {
  ...
  async create(reservation) {
    const { validateReservation } = await import('./validators');
...
export const maintenanceService = {
  ...
  async create(record) {
    const { validateMaintenanceRecord } = await import('./validators');
...
export const clientsService = {
  ...
  async create(client) {
    const { validateClient } = await import('./validators');
