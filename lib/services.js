...
export const packagesService = {
  ...
  async create(pkg) {
    ...
    const { items, notes: _notes, category, ...packageData } = pkg;
  ...
  async update(id, updates) {
    ...
    // Extract fields that aren't in DB schema
    const { items, notes: _notes, category, ...packageData } = updates;
...
export const packListsService = {
  ...
  async update(id, updates) {
    ...
    const { items, packages, packedItems: _packedItems, ...listData } = updates;
