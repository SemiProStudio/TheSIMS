...
import { renderRenditions, OUTPUT_TYPE } from './imageProcessing.js';
...
// A stalled upload must surface as an error the UI can show, never an
// "Uploading…" button that stays disabled forever
...
export const storageService = {
  ...
  async uploadRenditions({ full, thumb }, folder) {
    ...
    const [fullResult, thumbResult] = await withTimeout(
      Promise.all([
