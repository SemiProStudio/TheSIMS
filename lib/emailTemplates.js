...
/** "Monday, August 25, 2026" — same format the daily job uses */
...
export function formatEmailDateTime(value, { seconds = false } = {}) {
 ...
 */
export function resolveBorrowerUserId({ borrowerName, borrowerEmail, clientId, users }) {
