 ...
 * @param {function} [options.onBlocked] - Called when the popup is blocked
 */
export function openPrintWindow({ title, styles, body, delay = 500, onBlocked }) {
...
<body>${body}</body>
  ...
  if (!w) {
    ...
    if (onBlocked) {
      ...
      // Fallback: use console warning instead of alert()
      console.warn('Print pop-up blocked. Please allow pop-ups for this site.');
    }
    return null;
  }
