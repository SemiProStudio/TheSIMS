...
export function FieldRow({
  ...
  const value = fieldData ? (selectedValue !== undefined ? selectedValue : fieldData.value) : '';
  const isEmpty = !value;
  ...
  return (
    ...
    >
      ...
      <div
        onClick={() =>
          onLineClick && fieldData?.lineIndex != null && onLineClick(fieldData.lineIndex)
        }
        style={{
      ...
      <div style={{ position: 'relative' }}>
        {isEmpty ? (
          ...
          <div>
            ...
            >
              ...
              {hasAlts && (
                ...
                >
                  ...
                  <span>
                    {fieldData.alternatives.length}{' '}
                    {fieldData.hasConflict ? 'conflicts' : 'options'}
                  </span>
                </button>
              )}
            </div>
            ...
            {/* Source key hint */}
            {fieldData.sourceKey &&
              fieldData.sourceKey.toLowerCase() !== specName.toLowerCase() && (
                <div
                  style={{
                    fontSize: 11,
            ...
            {unitInfo && (
              ...
              >
                →
                <span>
                  normalized: <strong>{unitInfo.normalized}</strong>
                </span>
              </div>
            )}
            {/* Type coercion hint */}
            {coercionInfo && !unitInfo && (
              ...
              >
                →
                <span>
                  suggestion: <strong>{coercionInfo.coerced}</strong>
                </span>
              </div>
            )}
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        border: 'none',
                        borderBottom:
                          i < fieldData.alternatives.length - 1
                    ...
                    >
                      {isSelected && (
                        <Check size={12} style={{ color: colors.primary, flexShrink: 0 }} />
                      )}
