...
import { useItemForm } from '../components/ItemForm';
...
interface ItemModalProps {
  ...
  categories: string[];
  categorySettings?: Record<string, { trackSerialNumbers?: boolean; trackQuantity?: boolean; trackReorderPoint?: boolean }>;
...
// Item Modal (Add/Edit)
// ============================================================================
export const ItemModal = memo<ItemModalProps>(function ItemModal({ isEdit, itemId, itemForm, setItemForm, specs, categories, categorySettings, locations, inventory, onSave, onClose, onDelete }) {
