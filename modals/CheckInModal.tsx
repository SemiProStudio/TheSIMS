...
interface CheckInModalProps {
  ...
  onCheckIn: (data: Record<string, any>) => void;
  onClose: () => void;
}

export const CheckInModal = memo<CheckInModalProps>(function CheckInModal({
  item,
  currentUser,
  onCheckIn,
  onClose
    ...
    <Modal onClose={onClose} maxWidth={550}>
      ...
      <div style={{ padding: spacing[4], maxHeight: '75vh', overflowY: 'auto' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: spacing[3], ...styles.textSmMuted }}>
            <div>
