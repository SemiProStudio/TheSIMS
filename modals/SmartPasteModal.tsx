...
interface SmartPasteModalProps {
  ...
  onApply: (payload: Record<string, any> | Record<string, any>[]) => void;
  onClose: () => void;
  existingItem?: Record<string, any>;
}

export const SmartPasteModal = memo<SmartPasteModalProps>(function SmartPasteModal({ specs, onApply, onClose, existingItem }) {
