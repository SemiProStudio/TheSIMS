...
interface ItemSearchProps {
  ...
  onAddItem: (item: ReservationItem) => void;
  placeholder?: string;
}
...
interface ReservationModalProps {
  ...
  setReservationForm: (fn: (prev: ReservationForm) => ReservationForm) => void;
  onSave: () => void;
  onClose: () => void;
  clients?: Client[];
  inventory?: ReservationItem[];
...
// ============================================================================
const ItemSearch = memo<ItemSearchProps>(function ItemSearch({
  inventory,
  selectedItemIds,
  onAddItem,
...
// Selected Item Card
// ============================================================================
const SelectedItemCard = memo<SelectedItemCardProps>(function SelectedItemCard({ item, onRemove, conflicts }) {
...
// ============================================================================
export const ReservationModal = memo<ReservationModalProps>(function ReservationModal({
  isEdit,
  reservationForm,
  setReservationForm,
  onSave,
