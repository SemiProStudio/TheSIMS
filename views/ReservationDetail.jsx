...
function ReservationDetail({
  ...
  const isOverdue =
    reservation.dueBack && reservation.dueBack < getTodayISO() && item.status === 'checked-out';
      ...
      <div className="responsive-two-col" style={{ display: 'grid', gap: spacing[6] }}>
        ...
        <div>
          ...
          <Card style={{ marginBottom: spacing[5] }}>
            ...
            >
              <Calendar size={16} /> Schedule & Location
            </h3>
            <div
              style={{
                display: 'grid',
            ...
            >
              ...
              >
                ...
                >
                  {formatDate(reservation.end || reservation.dueBack)}
                  {isOverdue && ' (OVERDUE)'}
                </div>
              </div>
            </div>
          ...
          <Card>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: spacing[3] }}>
              ...
              {!reservation.contactPhone && !reservation.contactEmail && (
                <p style={{ color: colors.textMuted, fontSize: typography.fontSize.sm }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: spacing[4] }}>
          ...
          <Card padding={false}>
            <CardHeader
              title={itemCount > 1 ? `Equipment (${itemCount})` : 'Equipment'}
              icon={Package}
            />
            <div
              style={{
            ...
            <div style={{ padding: spacing[4] }}>
              <div style={{ marginBottom: spacing[3] }}>
                ...
                <div style={{ fontSize: typography.fontSize.base, color: colors.textPrimary }}>
                  {reservation.projectType || 'Not specified'}
                </div>
              </div>
              <div>
                <div
          ...
          <Card>
            ...
            >
              ...
              {(reservation.notes || []).filter((n) => !n.deleted).length > 0 && (
                <Badge
                  text={`${(reservation.notes || []).filter((n) => !n.deleted).length}`}
