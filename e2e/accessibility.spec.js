...
test.describe('Theme System', () => {
  ...
  test.describe('Theme Selection', () => {
    test('should navigate to theme selector', async ({ page }) => {
      ...
      const themeOption = page.locator('button:has-text("Theme"), a:has-text("Theme"), [aria-label*="theme"]');
    ...
    test('should display available themes', async ({ page }) => {
      ...
      if (await themeOption.isVisible()) {
        ...
        const themeCards = page.locator('[data-testid="theme-card"], [role="button"]').filter({ hasText: /Dark|Light|Theme/ });
...
test.describe('Accessibility', () => {
  ...
  test.describe('Keyboard Navigation', () => {
    ...
    test('should show visible focus indicators', async ({ page }) => {
      ...
      const hasVisibleFocus = focusedElement && (
    ...
    test('focus ring should be visible', async ({ page }) => {
      ...
      const focusRingColor = await page.evaluate(() => {
        return getComputedStyle(document.documentElement)
          .getPropertyValue('--focus-ring-color').trim();
      });
