...
class NotificationSettingsPage {
  constructor(page) {
    ...
    // Due date section
    this.dueDateRemindersToggle = page
      .locator('text=Due Date Reminders')
      .locator('..')
      .locator('button')
      .first();
    this.overdueToggle = page
      .locator('text=Overdue Notifications')
      .locator('..')
      .locator('button')
      .first();
    ...
    // Reservation section
    this.reservationConfirmToggle = page
      .locator('text=Confirmation Emails')
      .locator('..')
      .locator('button')
      .first();
    this.reservationReminderToggle = page
      .locator('text=Reservation Reminders')
      .locator('..')
      .locator('button')
      .first();

    // Checkout section
    this.checkoutConfirmToggle = page
      .locator('text=Checkout Confirmations')
      .locator('..')
      .locator('button')
      .first();
    this.checkinConfirmToggle = page
      .locator('text=Check-in Confirmations')
      .locator('..')
      .locator('button')
      .first();
    ...
    this.lowStockToggle = page
      .locator('text=Low Stock Alerts')
      .locator('..')
      .locator('button')
      .first();
    this.damageReportsToggle = page
      .locator('text=Damage Reports')
      .locator('..')
      .locator('button')
      .first();
    this.overdueSummaryToggle = page
      .locator('text=Overdue Summary')
      .locator('..')
      .locator('button')
      .first();
...
extendedTest.describe('Notification Settings UI', () => {
  ...
  extendedTest(
    'should display admin section for admin users',
    async ({ page, notificationPage }) => {
      const notificationsButton = page.locator('button:has-text("Notifications")');
      if (await notificationsButton.isVisible()) {
        await notificationsButton.click();
        await notificationPage.expectOpen();
...
extendedTest.describe('Notification Settings Interactions', () => {
  ...
  extendedTest(
    'should save preferences and show success message',
    async ({ page, notificationPage }) => {
      const notificationsButton = page.locator('button:has-text("Notifications")');
      if (await notificationsButton.isVisible()) {
        await notificationsButton.click();
    ...
    if (await firstItem.isVisible()) {
      ...
      if (await addReservationButton.isVisible()) {
        ...
        const projectInput = page
          .locator('input[placeholder*="Project" i], input[name="project"]')
          .first();
