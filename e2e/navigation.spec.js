...
test.describe('Navigation', () => {
  ...
  test.describe('Sidebar Navigation', () => {
    test('should navigate to Gear List', async ({ page, pages }) => {
      ...
      await expect(page.locator('h1:has-text("Gear List"), h1:has-text("Inventory")')).toBeVisible({ timeout: 10000 });
    });
  ...
  test.describe('Browser Navigation', () => {
    test('should support browser back button', async ({ page, pages }) => {
      ...
      await expect(page.locator('h1:has-text("Gear List"), h1:has-text("Inventory")')).toBeVisible({ timeout: 5000 });
    });
  ...
  test.describe('Responsive Sidebar', () => {
    test('should collapse on mobile viewport', async ({ page, pages }) => {
      ...
      const hamburgerButton = page.locator('button[aria-label*="menu"], button.menu-toggle, [data-testid="mobile-menu"]');
